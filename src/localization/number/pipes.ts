...
function formatNumber(token: IPromiseCancelToken, value: number, options: NumberFormatOptions | undefined, locale: string | undefined, notification: KeyValueMapToNotifications<INumberFormatServiceKeyValueMap>): Promise<string> {
