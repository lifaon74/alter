...
function translate(token: IPromiseCancelToken, key: string, params: any, locale: string | undefined, notification: KeyValueMapToNotifications<ITranslateServiceKeyValueMap>): Promise<string> {
