 ...
 */
export function GetCustomElementHTMLElementConstructor<TFunction extends Constructor<HTMLElement>>(target: TFunction | null): TFunction | null {
  while (target !== null) {
...
export function GetCustomElementObservedAttributes(target: Constructor<HTMLElement>, stopOnFirstMatch: boolean = true): Set<string> {
  ...
  let superClass: Constructor<Object> | null = target;
