...
import { GetObservablePrivates } from '../../../../../misc/helpers/observables-helpers';
import { IObservablePrivate } from '@lifaon/observables/types/core/observable/privates';
...
export function ConstructDynamicEventListener(instance: IDynamicEventListener): void {
  ...
  const observablePrivates = GetObservablePrivates(instance);

  const _onObserveHook = observablePrivates.onObserveHook;
  observablePrivates.onObserveHook = function onObserveHook(observer: IObserver<INotification<string, IEventLike>>) {
