...
export const ExtendableHTMLElement: (new(name: string, doc?: Document) => HTMLElement) = function ExtendableElement(this: any, name: string, doc: Document = document): HTMLElement {
